...
class BufferManager{
    ...
    Page insertIntoPool(string tableName, int tableIndex, int pageIndex);

    public:
    
    BufferManager();
    Page getPage(string tableName, int pageIndex);
    Page getPage(string tableName, int tableIndex, int pageIndex);
    void writePage(string pageName, vector<vector<int>> rows);
    void deleteFile(string tableName, int pageIndex);
    void deleteFile(string tableName, int tableIndex, int pageIndex);
    void deleteFile(string fileName);
    void writePage(string tableName, int pageIndex, vector<vector<int>> rows, int rowCount);
    void writePage(string tableName, int tableIndex, int pageIndex, vector<vector<int>> rows, int rowCount);
};